...
class _UserControllerState extends State<UserController> {
  ...
  static _UserControllerState get instance => _instance = _instance??_UserControllerState._();
  ...
  Future<ApiResponse> _cadastrar(User user, GlobalKey<FormState> formKey) async {
    ...
    try {
      ...
      if (fUser != null) {
        ...
        DocumentReference refUser = Firestore.instance.collection("user")
      ...
      if (error is PlatformException) {
        ...
        return ApiResponse.ok(msg: "Erro ao criar o usuário.\n\n\Este e-mail já foi cadastrado em nosso sistema.");
      }
